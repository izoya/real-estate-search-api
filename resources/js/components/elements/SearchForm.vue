    ...
    <div class="center">
        <el-form ref="form" :model="form" label-width="120px">
            ...
            <el-form-item label="Bedrooms">
                <el-select v-model="form.bedrooms" name="bedrooms" clearable
            ...
            <el-form-item label="Bathrooms">
                <el-select v-model="form.bathrooms" name="bathrooms" clearable
            ...
            <el-form-item label="Storeys">
                <el-select v-model="form.storeys" name="storeys" clearable
            ...
            <el-form-item label="Garages">
                <el-select v-model="form.garages" name="garages" clearable
